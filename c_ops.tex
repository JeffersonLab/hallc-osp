...
\begin{center}
%\htmlimage{flip=r270}
\includegraphics[width=6in,angle=270]{superharp-system.ps2}
...
\includegraphics{superharp-flowchart.ps2}
...
\includegraphics[height=6.5in,width=5.5in]{superharp_interface.ps2}
...
\begin{figure}[!hbt]
\begin{center}
\includegraphics{scan-panel.eps}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[height=4in,width=6in]{polarimeter.eps}
...
width.
\begin{figure}
\includegraphics[height=4in,width=6in]{detarangement.epsf}
\begin{center}
\parbox{10cm}{
...
%
\begin{figure}
\includegraphics[height=4in]{collim.eps}
\begin{center}
...
%  \htmlimage{scale=1.0,thumbnail=0.5}
  \includegraphics[height=4in]{mollergui.ps}
