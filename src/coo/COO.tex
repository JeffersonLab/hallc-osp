...
%
%
% Hall C definitions for Standard COO input
\input{coo_hallc_defs.tex}
...
\item Procedures describing each new piece
of equipment to be used, their operation, mitigated hazards,
responsible personnel and signature pages to grant authorization to
others to operate after being trained on the equipment.
...
All personnel taking on-site shifts (i.e. personnel able to access the
hall if needed) are required to have successfully completed and be
...
%{\bf Lockout/Tagout (ESC 007)} and {\bf Practical Exercise (ESC 008)}
%are required for all staff/users who will be
...
%source. 
% This training, SAF104, can be found at:   \newline
...
18 and over may be allowed to work in the halls (following all other aforementioned rules)
with the provision that their work in the hall is always under the supervision of a 
Hall C authorized person (i.e. a buddy), though that person may not be another undergraduate.
...
Off-site shift personnel have no access to the hall due to their
physical location, missing training or other reasons and consequently
they are not subject to the training requirements of on-site shift
personnel. Their training requirements are determined by the methods
they will use to participate in the experiment, e.g. training required
to obtain a JLab computer account and have remote access to the
experiment computing systems.
...
in the hall), active Permits To Work (PTWs), required temporary work permits
...
should be noted in the logbook. Some requests may require that a Permite to Work (PTW) is ePAS be developed.
...
appropriate personnel. The Hall Leader may require that a PTW be prepared.
