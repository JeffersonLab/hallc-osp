...
\label{sec:intro-about}
 ...
 moved to the Jefferson Lab github repository~\cite{hallc-github} with a full copy stored on the 
Hall C's web pages~\cite{hallcweb-github}.
...
provide a momentum resolution of better than $1\times 10^{-3}$ and a horizontal angular 
resolution of better than 2 mrad at a design maximum central momenta of
$7.5~\textrm{Gev}/c$ and $11~\textrm{Gev}/c$.
