...
The Hall C cryotarget system allows for multiple configurations depending
...
is available at \url{http://hallcweb.jlab.org/equipment/targets/cryotargets/Hallc\_tgt.html}.
An updated User's Guide to the Hall C Cryotarget is available at \url{https://polweb.jlab.org/guides/atarg/ATARG\_MAN.html}.
...
training usually takes place in the Hall C counting house and consists
...
Hall C contains a significant amount of electrical equipment and almost
...
valves exhaust to the Hall C hydrogen vent line. This line is 2 inch
...
in an inert environment until it is released outside of Hall C. Additionally,
...
\sawnote{Is freezing still a thing if we always use 15K?}
...
C volume is 40,000 m$^{3}$, the ODH hazard is minimal. 
...
system use a PC, and also require the Hall C Hewlett Packard, HP,
...
C Technicians} \TechonCall{Vacuum} \AndyKenyon{Vacuum} \namestabheader{Hall
C Physicists} \CryotargonCall{Cryotarget}
\GregSmith{Cryotarget}\SilviuCovrig{Cryotarget}
