...
Below the loops, solid targets such as carbon foils can be added.  A
...
screenshot of the main target GUI is shown if
...
channels. %\begin{safetyen}{0}{0} If the AH alarms repeatedly or the
cause of the alarm is not clear, the target operator should contact
the on-call target expert. The ALH GUI and its secondary GUIs are
...
group's web page at
\url{https://polweb/hallc/Cryotarget/Target%20Safety%20Assessment%20Document1.5.doc}.
...
\url{https://polweb/hallc/Cryotarget/In%20chamber%20work.doc}, and
  that for disconnecting the target is found here:
  \url{https://polweb/hallc/Cryotarget/Disconnect%20Target.doc}.  A
    ...
    \url{https://polweb/hallc/Cryotarget/Target-operation-manual.pdf}.
...
\url{https://polweb/guides/ctarg/CTARG_MAN.html}. The resource
