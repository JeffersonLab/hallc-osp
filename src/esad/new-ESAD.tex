...
with sub-systems of the base equipment of the experimental hall, experiment
specific equipment and their 
...
This ESAD applies to experiments using the Polarized Helium-3 Target.
The safety aspects of this target are discussed in
Chapter~\ref{chap:expspecific}, 
``Experiment Specific Equipment.''
The standard Hall C cryotarget is removed entirely when the Helium-3
Target is installed.  Discussion of the standard target has been
removed from this ESAD.
...
management procedures. The JLab fire marshal (Tim Minga) can be contacted at 269-7310. % or 757-371-1687.
...
Contact Dave Kashy at 269-7275 in case of questions or concerns.   
...
(Scott Conely) 
can be contacted as follows: Office: 269-7308, Cell: 757-814-6472.
...
The LSO (Paul Collins) can be reached as follows: Office 269-5981 or Email paulc@jlab.org.
