...
%%%TODO
This ESAD applies to experiment E12-11-107 which uses the installation of the Large Acceptance Detector (LAD) in Hall C. The safety aspects of this experimental configuration are discussed in Chapter~\ref{chap:expspecific}, 
``Experiment Specific Equipment.'' These experiment-specific considerations include the rotated scattering chamber, LAD, and the inclusion of two tracking GEM planes on the SHMS platform. 
