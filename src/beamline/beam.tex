...
detailed in Fig.~\ref{fig:beamlineresponsibilities}
\begin{figure}
  \begin{center}
\includegraphics[width=1.1\textwidth,trim={0 1in 0 1in}]{Beamline_Responsibilities-3.pdf}
\caption{Beamline elements with operational and fiscal responsibilites.}
\label{fig:beamlineresponsiblities}
\end{center}
\end{figure}
}
