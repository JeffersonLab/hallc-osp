...
show in
shown on Figs.~\ref{fig:Cline1},~\ref{fig:Cline2} and \ref{fig:Cline3}. 
...
are able to deliver beam onto the hall C target in the achromatic
mode. 
...
\end{tabular}
\end{center}
\caption[Beamline: Optics Requirements Target]{ Line C Optics and Beam Requirements at Target}
\label{beam_tab3}
\end{table}
...
\sawnote{Replace this section with description of Hall C beamline.
Will need to include discussion of the HB fringe fields and shielded beam
pipe.}
...
\sawnote{Is this true in Hall C?  What magnets in Hall C require
Lock and Tag?}
