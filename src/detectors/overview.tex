...
in the path of the detectors.  (The SHMS Noble Gas Cherenkov will
...
\item[]\textbf{Gas Cherenkov detectors} Depending on momentum and index of
refraction of the gas used, provide either discrimination between
electrons and pions, or between pions and kaons
\item[]\textbf{Aerogel Cherenkov} Contain an Aerogel radiator and a diffusion box
  with PMTs to collect Cherenkov light.  These detectors aid in the
