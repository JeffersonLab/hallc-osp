...
\begin{figure}[ht]
\centering
\includegraphics[width=0.75\linewidth]{image/cherenkov_front.eps}
...
\begin{figure}
     \centering
     \subfloat[][Regular Signal]{\includegraphics[width=0.45\linewidth]{image/pmt4_1047}\label{hgc:goodsignal}}~
     \subfloat[][Discharge]{\includegraphics[width=0.45\linewidth]{image/discharge}\label{hgc:discharge}}
