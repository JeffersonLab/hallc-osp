...
% FIXME BDS (Add valve names, verify steps in detector hut)
% \begin{itemize}
% \item Valves {\bf TBD} are closed.
% \end{itemize}
% The tank is now ready to be evacuated.
% \begin{itemize}
%   \item Turn on the pump.
%   \item Slowly open {\bf TBD}.  This evacuates the pump line.
%   \item Open very slowly {\bf TBD}.  Since this valve connects the pump line to
%     the detector volume, the pump will work very hard.  Meter this valve so that
%     the pump is never under extreme stress.  It will take approximately
...
%   \item When {\bf G3} or {\bf EPG} reach the operating pressure, close the
%     manifold valve.
%   \item Close {\bf V3}.
% \end{itemize}
