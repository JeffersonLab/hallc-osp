...
\subsection{Super HMS Noble Gas Cherenkov Detector}
...
Cherenkov Detector shoulders a large portion of this particle
identification burden.  The design of the noble gas threshold \v
Cherenkov detector is such that it will meet these twin goals of
...
The basic equation  governing Cherenkov radiation emitted by a particle
...
Cherenkov radiation will be emitted.
 \begin{figure}[!h] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.9\textwidth]{ngc-partsep.pdf}
...
\newpage
\vspace{.25in}
\noindent {\bf Description of the Cherenkov}
\vspace{.25in}
...
\vspace{.25in}
\noindent {\bf{Additional Documentation}}
