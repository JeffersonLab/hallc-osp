...
(Figure~\ref{fig:shms-shower-2}  The blocks are stacked in two columns in
...
\caption{\label{fig:shms-shower-3}Schematic of SHMS Shower array as
...
calorimeter, stacked in a ``fly’s eye'' configuration of 14 columns
and 16 rows.  (Figure~\ref{fig:shms-shower-3}) Each module is
