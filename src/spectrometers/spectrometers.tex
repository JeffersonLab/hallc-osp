...
sufficiently high fields, these fringe fields will deflect the
electron beam beyond acceptable limits at the dump.  Depending on the
kinematics requirement for the upcoming experiment, magnetic shielding
will be installed to minimize the deflection of the beam.

For a given shielding configuration, restrictions on
SHMS angles and magnet settings will be established.
Furthermore, under certain combinations of angles and magnet settings,
the shift crew will be required to notify MCC before making changes to
the spectrometer angle or magnet fields.
}
