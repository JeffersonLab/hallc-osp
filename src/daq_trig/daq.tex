...
%
% Note address of new logbook.  Note that each shift worker making
% logbook entries needs to login to the logbook with their JLab username
% (And logout at end of shift)
% Describe how to startup bta and login stuff.  Describe
% meanings of beam in use, beam available but not in use.  BNA.
